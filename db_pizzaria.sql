...
INSERT INTO `tbl_contato` VALUES (1,'Ruan Santos',NULL,'(11)-99021-6755','ruanSantos@gmail.com','O queijo da pizza estava meio cru');
...
INSERT INTO `tbl_funcionario` VALUES (1,'Pedrovss','pedrovs3@gmail.com','(11)03033-0303','pedrooo3',NULL);
...
INSERT INTO `tbl_funcionarios` VALUES (1,1,1);
...
INSERT INTO `tbl_mensagens` VALUES (1,1,1);
...
INSERT INTO `tbl_pizza` VALUES (1,'Marguerita');
...
INSERT INTO `tbl_pizza_componentes` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1);
...
--
-- Table structure for table `tbl_pizza_tamanhos`
--

DROP TABLE IF EXISTS `tbl_pizza_tamanhos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_pizza_tamanhos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_tamanhos` int NOT NULL,
  `id_pizza` int NOT NULL,
  `preco` double NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  KEY `FK_tamanho_pizza_pizza_tamanhos` (`id_tamanhos`),
  KEY `FK_pizza_pizza_tamanhos` (`id_pizza`),
  CONSTRAINT `FK_pizza_pizza_tamanhos` FOREIGN KEY (`id_pizza`) REFERENCES `tbl_pizza` (`id`),
  CONSTRAINT `FK_tamanho_pizza_pizza_tamanhos` FOREIGN KEY (`id_tamanhos`) REFERENCES `tbl_tamanho_pizza` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_pizza_tamanhos`
--

LOCK TABLES `tbl_pizza_tamanhos` WRITE;
/*!40000 ALTER TABLE `tbl_pizza_tamanhos` DISABLE KEYS */;
INSERT INTO `tbl_pizza_tamanhos` VALUES (1,3,1,70.5);
/*!40000 ALTER TABLE `tbl_pizza_tamanhos` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-12-05  8:18:38
